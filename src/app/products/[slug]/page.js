          ...
          <div className="space-y-6">
            ...
            <div className="p-6 bg-white/[0.02] border border-white/5 rounded-xl">
              ...
              <div className="grid grid-cols-2 gap-4 text-[10px] uppercase font-space-mono">
                ...
                <div className="text-slate-500">
                  Sample Rate:{" "}
                  <span className="text-white">44.1kHz, 48kHz, 96kHz</span>
                </div>
                {product.decayCurve && (
                  <div className="text-slate-500">
                    Decay Curve:{" "}
                    <span className="text-white">{product.decayCurve}</span>
                  </div>
                )}
                {product.modes && (
                  <div className="text-slate-500">
                    Modes: <span className="text-white">{product.modes}</span>
                  </div>
                )}
                ...
                {product.totalFiles && (
                  <div className="text-slate-500">
                    Total Files:{" "}
                    <span className="text-white">{product.totalFiles}</span>
                  </div>
                )}
              </div>
            </div>
