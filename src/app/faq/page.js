      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="mb-16 text-center">
          ...
          <p className="text-slate-400 text-xl">
            Everything you need to know about our musically-tuned impulse
            responses
          </p>
        </div>
          ...
          <div className="space-y-8">
            ...
            <div className="glass-card p-6 rounded-xl">
              <h3 className="font-space-grotesk text-xl font-bold text-white mb-3">
                What makes these Impulse Responses different from traditional
                room captures?
              </h3>
              <p className="text-slate-300 leading-relaxed">
                Traditional IRs are recordings of physical spaces. These IRs are{" "}
                <span className="font-bold text-white">
                  mathematically sculpted from the ground up
                </span>
                . Instead of natural reverb, they use alghorithmic equations to
                define how sound decays, ensuring a level of precision and
        ...
        <section className="mb-16">
          ...
          <div className="space-y-8">
            ...
            <div className="glass-card p-6 rounded-xl">
              ...
              <p className="text-slate-300 leading-relaxed">
                Most reverb impulses only focus on a narrow frequency band. Our
                IRs are generated across a{" "}
                <span className="font-bold text-white">
                  full 9-octave range
                </span>
                . This ensures that whether you are processing a deep sub-bass
                or a high-frequency synth lead, the harmonic support remains
                consistent and full-spectrum.
              </p>
            </div>
            ...
            <div className="glass-card p-6 rounded-xl">
              ...
              <p className="text-slate-300 leading-relaxed">
                Files labeled <span className="font-bold text-white">MS</span>{" "}
                have been built using Mid-Side processing. This means the "Mid"
                (center) and "Side" (width) of the reverb have independent decay
                behaviors, allowing you to keep a focused phantom center while
            ...
            <div className="glass-card p-6 rounded-xl">
              ...
              <p className="text-slate-300 leading-relaxed">
                ...
                <span className="font-bold text-white">
                  frequency area of each decay band is constant
                </span>
                . This prevents any specific frequency from building up over
                time, resulting in an incredibly transparent and balanced decay,
          ...
          <div className="space-y-8">
            ...
            <div className="glass-card p-6 rounded-xl">
              ...
              <p className="text-slate-300 leading-relaxed">
                ...
                (all at 24-bit depth), ensuring compatibility with any
                professional DAW project.
              </p>
            </div>
            ...
            <div className="glass-card p-6 rounded-xl">
              ...
              <ul className="space-y-3 text-slate-300">
                <li>
                  <span className="font-bold text-white">WN / WPN:</span> White
                  Noise or White and Pink Noise generators.
                </li>
                <li>
                  <span className="font-bold text-white">FT / HW:</span>{" "}
                  Fountain water or Wind sounds used as organic texture
                  generators.
                </li>
                <li>
                  <span className="font-bold text-white">AST / G30 / WA:</span>{" "}
                  The mathematical Fall Curve used (Astroid, Gold 30, or Witch
                  of Agnesi).
                </li>
              </ul>
            </div>
        ...
        <div className="text-center mt-20 p-8 bg-white/[0.02] border border-white/5 rounded-xl">
          ...
          <p className="text-slate-400 mb-6">
            Feel free to reach out to us for more information about our impulse
            responses.
          </p>
          <a
            href="/collections"
